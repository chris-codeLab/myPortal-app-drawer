setTimeout(async function () {
    ...
    const webSocketUrls = 'wss://localhost:44356/MyPortalV5/,ws://localhost:63164/MyPortalV5/'.split(',');
    const sharedSecret = await getSecret('');
    let connection;
