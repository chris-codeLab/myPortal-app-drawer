...
(function($){
    var defaults = {
        ...
        texts: {
            ...
            clearAll       : 'Clear All (Any)',      // clear all text WPS 4/12/2023
        },
        ...
        clearAll               : true,  // show clear all option WPS 4/12/2023
        ...
        onClearAll    : function (element) {},               // fires when the clear all option is clicked
    };
    ...
    MultiSelect.prototype = {
        ...
        load: function() {
            ...
            // add clear all option WPS 4/12/2023
            if (instance.options.clearAll) {
                optionsList.before('<a href="#" class="ms-clearall global">' + instance.options.texts.clearAll + '</a>');
            }

            // handle clear all option WPS 4/12/2023
            optionsWrap.on('click', '.ms-clearall', function (event) {
                event.preventDefault();
